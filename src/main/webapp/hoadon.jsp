...
<section class="food_section layout_padding">
    ...
    <div align="center">
        ...
        <table class="table table-dark table-striped" >
            ...
            <tr>
                <td colspan="2" align="center">Total Bill <h3>${hoadon.trigia}</h3> <input type="text" name="trigia" id="trigia" value="${hoadon.trigia}"  hidden disabled></td>
                <td>
                    <a class="btn btn-info btn-lg" style="color: white" style="color: white" href="/index?action=logout"> Back to home </a>
               </td>
            </tr>
        </table>
<h1> </h1>
