                    ...
                    <table class="table table-dark table-striped" border="1" cellpadding="5">
                        ...
                        <c:forEach var="gh" items="${list}">
                            <tr>
                                ...
                                <td>
                                    <a style="color: white" class="btn btn-info btn-lg" href="/giohang?order=delete&id=${gh.idsp}"> X </a>
                                </td>
                            </tr>
                        </c:forEach>
                        <tr>
...
<%--                                <input type="submit" value="Thanh toan">--%>
                                <button type="submit" style="height: 50px; width: 80px"  value="Thanh toan" class="btn btn-dark"> Pay up </button>
                                <a class="btn btn-info btn-lg" style="color: white" href="/menu.jsp">Back</a>
                            </td>
