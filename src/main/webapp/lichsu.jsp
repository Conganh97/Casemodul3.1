            ...
            <table class="table table-dark table-striped">
                ...
                <c:forEach var="hd" items="${list}">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-lg" size="30" style="color: white" style="color: white" href="/giohang?order=chitiet&idhdct=${hd.idhd}">Chi tiet</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
                    <td colspan="5" align="center">
                        ...
                        <a class="btn btn-info btn-lg" style="color: white" style="color: white" href="/menu.jsp">Back</a>
                    </td>
                </tr>
            </table>
        </form>
