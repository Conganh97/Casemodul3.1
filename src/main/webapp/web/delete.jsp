        ...
        <div align="center">
            <form method="post">
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2"  align="center"><button type="submit" class="btn btn-dark">Delete</button>
                        <button type="submit" class="btn btn-dark"><a a style="background: none ; color: white" href="/admin">Back</a></button> </td>
                    </tr>
                </table>
            </form>
